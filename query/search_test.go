...
func TestBuildSearchQueryContent(t *testing.T) {
	c.Convey("Should generate the expected query to be sent to elasticsearch", t, func() {
		...
		c.So(string(searches[0].Query), c.ShouldEqual, `{"from":1,"size":2,"query":{"bool":{"should":[],"must":{"function_score":{"query":{"dis_max":{"queries":[{"bool":{"should":[{"match":{"title.title_no_dates":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"match":{"title.title_no_stem":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"multi_match":{"query":"a","fields":["title^10","edition"],"type":"cross_fields","minimum_should_match":"3<80% 5<60%"}},{"multi_match":{"query":"a","fields":["title^10","summary","metaDescription","edition","keywords"],"type":"phrase","boost":10.0,"slop":2}}]}},{"multi_match":{"query":"a","fields":["summary","metaDescription","keywords"],"type":"best_fields","minimum_should_match":"75%"}},{"multi_match":{"query":"a","fields":["cdid","dataset_id","uri"]}}]}},"functions":[{"filter":{"term":{"type":"bulletin"}},"weight":100},{"filter":{"term":{"type":"dataset_landing_page"}},"weight":70},{"filter":{"terms":{"type":["article","statistical_article","compendium_landing_page","article_download"]}},"weight":50},{"filter":{"term":{"type":"static_adhoc"}},"weight":30},{"filter":{"term":{"type":"timeseries"}},"weight":10}]}},"filter":[{"bool":{"must":[{"bool":{"should":[{"match":{"type":"ta"}},{"match":{"type":"tb"}}]}},{"bool":{"should":[{"range":{"release_date":{"gte":null,"lte":null}}}]}},{"bool":{"should":[{"match":{"canonical_topic":"test"}},{"match":{"topics":"test"}}]}}]}}]}},"suggest":{"search_suggest":{"text":"a","phrase":{"field":"title.title_no_synonym_no_stem"}}},"_source":{"includes":[],"excludes":["downloads.content","downloads*","pageData"]},"highlight":{"pre_tags":["<em class=\"ons-highlight\">"],"post_tags":["</em>"],"fields":{"terms":{"fragment_size":0,"number_of_fragments":0},"title":{"fragment_size":0,"number_of_fragments":0},"edition":{"fragment_size":0,"number_of_fragments":0},"summary":{"fragment_size":0,"number_of_fragments":0},"meta_description":{"fragment_size":0,"number_of_fragments":0},"keywords":{"fragment_size":0,"number_of_fragments":0},"cdid":{"fragment_size":0,"number_of_fragments":0},"dataset_id":{"fragment_size":0,"number_of_fragments":0},"downloads.content":{"fragment_size":45,"number_of_fragments":5},"pageData":{"fragment_size":45,"number_of_fragments":5}}},"sort":[{"_score":{"order":"desc"}},{"release_date":{"order":"desc"}}]}`)

		c.So(searches[1].Header, c.ShouldResemble, client.Header{Index: "ons"})
		c.So(string(searches[1].Query), c.ShouldEqual, `{"query":{"bool":{"must":{"dis_max":{"queries":[{"bool":{"should":[{"match":{"title.title_no_dates":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"match":{"title.title_no_stem":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"multi_match":{"query":"a","fields":["title^10","edition"],"type":"cross_fields","minimum_should_match":"3<80% 5<60%"}},{"multi_match":{"query":"a","fields":["title^10","summary","metaDescription","edition","keywords"],"type":"phrase","boost":10.0,"slop":2}}]}},{"multi_match":{"query":"a","fields":["summary","metaDescription","keywords"],"type":"best_fields","minimum_should_match":"75%"}},{"multi_match":{"query":"a","fields":["cdid","dataset_id","uri"]}}]}},"filter":[{"bool":{"must":[{"bool":{"should":[{"match":{"type":"ta"}},{"match":{"type":"tb"}}]}}]}}]}},"size":0,"aggregations":{"topic":{"terms":{"size":1000,"field":"topics"}}}}`)

		c.So(searches[2].Header, c.ShouldResemble, client.Header{Index: "ons"})
		c.So(string(searches[2].Query), c.ShouldEqual, `{"query":{"bool":{"must":{"dis_max":{"queries":[{"bool":{"should":[{"match":{"title.title_no_dates":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"match":{"title.title_no_stem":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"multi_match":{"query":"a","fields":["title^10","edition"],"type":"cross_fields","minimum_should_match":"3<80% 5<60%"}},{"multi_match":{"query":"a","fields":["title^10","summary","metaDescription","edition","keywords"],"type":"phrase","boost":10.0,"slop":2}}]}},{"multi_match":{"query":"a","fields":["summary","metaDescription","keywords"],"type":"best_fields","minimum_should_match":"75%"}},{"multi_match":{"query":"a","fields":["cdid","dataset_id","uri"]}}]}},"filter":[{"bool":{"must":[{"bool":{"should":[{"match":{"canonical_topic":"test"}},{"match":{"topics":"test"}}]}}]}}]}},"size":0,"aggregations":{"content_types":{"terms":{"size":1000,"field":"type"}}}}`)

		c.So(searches[3].Header, c.ShouldResemble, client.Header{Index: "ons"})
		c.So(string(searches[3].Query), c.ShouldEqual, `{"query":{"bool":{"must":{"dis_max":{"queries":[{"bool":{"should":[{"match":{"title.title_no_dates":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"match":{"title.title_no_stem":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"multi_match":{"query":"a","fields":["title^10","edition"],"type":"cross_fields","minimum_should_match":"3<80% 5<60%"}},{"multi_match":{"query":"a","fields":["title^10","summary","metaDescription","edition","keywords"],"type":"phrase","boost":10.0,"slop":2}}]}},{"multi_match":{"query":"a","fields":["summary","metaDescription","keywords"],"type":"best_fields","minimum_should_match":"75%"}},{"multi_match":{"query":"a","fields":["cdid","dataset_id","uri"]}}]}},"filter":[{"bool":{"must":[{"bool":{"should":[{"match":{"type":"ta"}},{"match":{"type":"tb"}}]}},{"bool":{"should":[{"match":{"canonical_topic":"test"}},{"match":{"topics":"test"}}]}}]}}]}},"size":0,"aggregations":{"population_type":{"terms":{"size":1000,"field":"population_type.agg_key"}}}}`)

		c.So(searches[4].Header, c.ShouldResemble, client.Header{Index: "ons"})
		c.So(string(searches[4].Query), c.ShouldEqual, `{"query":{"bool":{"must":{"dis_max":{"queries":[{"bool":{"should":[{"match":{"title.title_no_dates":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"match":{"title.title_no_stem":{"query":"a","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"multi_match":{"query":"a","fields":["title^10","edition"],"type":"cross_fields","minimum_should_match":"3<80% 5<60%"}},{"multi_match":{"query":"a","fields":["title^10","summary","metaDescription","edition","keywords"],"type":"phrase","boost":10.0,"slop":2}}]}},{"multi_match":{"query":"a","fields":["summary","metaDescription","keywords"],"type":"best_fields","minimum_should_match":"75%"}},{"multi_match":{"query":"a","fields":["cdid","dataset_id","uri"]}}]}},"filter":[{"bool":{"must":[{"bool":{"should":[{"match":{"type":"ta"}},{"match":{"type":"tb"}}]}},{"bool":{"should":[{"match":{"canonical_topic":"test"}},{"match":{"topics":"test"}}]}}]}}]}},"size":0,"aggregations":{"dimensions":{"terms":{"size":1000,"field":"dimensions.agg_key"}}}}`)
	})
}
...
func TestBuildCountQueryPopulationType(t *testing.T) {
	c.Convey("Given a Query builder", t, func() {
		...
		c.Convey("Then the expected count query is generated for a request with a term", func() {
			...
			expectedQueryString := `{"query":{"bool":{"must":[{"dis_max":{"queries":[{"bool":{"should":[{"match":{"title.title_no_dates":{"query":"someQuery","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"match":{"title.title_no_stem":{"query":"someQuery","boost":10.0,"minimum_should_match":"1<-2 3<80% 5<60%"}}},{"multi_match":{"query":"someQuery","fields":["title^10","edition"],"type":"cross_fields","minimum_should_match":"3<80% 5<60%"}},{"multi_match":{"query":"someQuery","fields":["title^10","summary","metaDescription","edition","keywords"],"type":"phrase","boost":10.0,"slop":2}}]}},{"multi_match":{"query":"someQuery","fields":["summary","metaDescription","keywords"],"type":"best_fields","minimum_should_match":"75%"}},{"multi_match":{"query":"someQuery","fields":["cdid","dataset_id","uri"]}}]}},{"bool":{"must":{"exists":{"field":"topics"}}}}]}}}`
			c.So(string(query), c.ShouldResemble, expectedQueryString)
		})
	})
}
