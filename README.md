...
Alternatively, you can just run the `dp-search-api` on it's own with `elasticsearch` v7.10 running on port 11200.
...
| NLP_SETTINGS                 | **_See below_**            | [NLP Settings](#nlp-settings)                                                                                      |
...
Copyright © 2016-2025, Office for National Statistics (<https://www.ons.gov.uk>)
